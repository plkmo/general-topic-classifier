...
def train_and_fit(args):
    ...
    net = ConvBertForSequenceClassification.from_pretrained('YituTech/conv-bert-base', num_labels=num_classes)
    print("VOCAB SIZE: %d" % len(tokenizer))
    print(net.convbert.embeddings.word_embeddings.weight.size())
    if cuda:
        net.cuda()
    ...
    optimizer = optim.Adam([{"params":net.convbert.parameters(),"lr": 0.0003},\
